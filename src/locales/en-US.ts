export default {
  ...
  pwa: {
    installApp: 'Install MitmPilot App',
    installDescription: 'Get better offline experience and performance',
    install: 'Install',
    installSuccess: 'App installed successfully!',
    installGuide: 'Installation Guide',
    installInstructions: 'Install MitmPilot on {platform}:',
    installNote:
      'After installation, you can quickly access MitmPilot from your home screen and enjoy offline features.',
    gotIt: 'Got it',
    ...
    installSteps: {
      ...
      chrome: {
        ...
        1: 'Or click "Install MitmPilot" in the browser menu',
  ...
  setting: {
    ...
    system: {
      ...
      apiToken: 'API Token',
      apiTokenHint: 'Set the token value used when external requests access MitmPilot API',
      ...
      moviePilotAutoUpdate: 'Auto Update MitmPilot',
      moviePilotAutoUpdateHint: 'Automatically update MitmPilot to the latest release version when restarting',
    ...
    site: {
      ...
      autoSyncIntervalHint: 'Time interval for automatically syncing site cookies from CookieCloud server to MitmPilot',
  ...
  dialog: {
    ...
    pluginMarketSetting: {
      ...
      repoPlaceholder: 'Format: https://github.com/wumode/MitmPilot-Addons/,https://github.com/xxxx/xxxxxx/',
  ...
  setupWizard: {
    ...
    basic: {
      ...
      recognizeSourceHint: 'Set the default media info recognition data source',
      apiToken: 'API Token',
      apiTokenHint: 'API Token required for accessing MitmPilot API, please record it for subsequent use',
